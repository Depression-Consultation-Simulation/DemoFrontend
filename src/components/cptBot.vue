<template>
    <div class="home-layout" v-loading="fanyiLoading" :class="isIos?'h-ios home-layout':'home-layout'">
        ...
        <el-dialog
            ...
            <el-form ref="form" :model="score_bot3" style="padding-left:8%;padding-right: 8%">
                <el-form-item>
                    <li >1. {{metrics[0]}}</li>
                    <el-slider
                            v-model="score_bot3.score1"
                            :step="1"
                            :max="5"
        ...
        <div class="h-body" id="hBody">
            ...
            <div :class="item.sign === 'vioce' || item.sign === 'msg' ? 'right-msg' : ''"
                ...
                <div class="txt1" v-if="item.sign === 'first'">
                    <div>
                        hi～我是心理健康助手小驰<b style="color: #9abdf9">三号</b>，和我打个招呼吧!
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            onSubmit() {
                ...
                axios
                    .post(url,{
                        ...
                        botId: 3,
                        score: JSON.stringify(this.score_bot3),
                    ...
                    .then((res) => {
                        ...
                        let target = this.$route.query.userId%3 === 0?"/result":"/bot1";
            ...
            clearData() {
                ...
                this.$confirm('此操作将永久删除聊天文件, 是否继续?', '提示', {
                    ...
                    this.isClear = true;
                    localStorage.removeItem('aiHistory3');
                    this.list = [{
                        sign: 'first',
                        time0: this.getTime()
                    }];
            ...
            getResult(msg, index) {
                let body = {"context":this.context,"input":msg, "model": "cpt"};
                console.log(body);
                axios
        ...
        created() {
            ...
            let obj = JSON.parse(localStorage.getItem("aiHistory3"));
            //test
            // list: [
            //   {name: '1'},
            //   {name: '2'},
        ...
        mounted() {
            ...
            window.onbeforeunload = (e) => {
                localStorage.setItem("aiHistory3", JSON.stringify(this.list));
                // return "";
            };
            let that = this;
            //苹果端
            window.addEventListener("pagehide", function () {
                localStorage.setItem("aiHistory3", JSON.stringify(that.list));
            }, false);
        },
