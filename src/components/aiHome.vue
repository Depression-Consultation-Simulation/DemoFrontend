...
<script>
    ...
    import {baseUrl, browserRedirect} from "../util/index";
    ...
    export default {
        ...
        methods: {
            ...
            getResult(msg, index) {
                let body = {"context":this.context,"input":msg};
                console.log(body);
                axios
                    .post(baseUrl,body)
                    .then((res) => {
        ...
        created() {
            ...
            let obj = JSON.parse(localStorage.getItem("aiHistory"));
            //test
            // list: [
            //   {name: '1'},
            //   {name: '2'},
        ...
        mounted() {
            ...
            window.onbeforeunload = (e) => {
                localStorage.setItem("aiHistory", JSON.stringify(this.list));
                // return "";
            };
            let that = this;
            //苹果端
            window.addEventListener("pagehide", function () {
                localStorage.setItem("aiHistory", JSON.stringify(that.list));
            }, false);
        },
